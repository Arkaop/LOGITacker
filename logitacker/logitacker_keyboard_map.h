...
DEF_REPORT_SEQUENCE_NAMED(LALT_AND_LSHIFT_AND_0,    	        DEF_REPORT(HID_MOD_KEY_LEFT_ALT, HID_KEY_LEFTSHIFT, HID_KEY_0));
DEF_REPORT_SEQUENCE_NAMED(LALT_AND_LSHIFT_AND_5,    	        DEF_REPORT(HID_MOD_KEY_LEFT_ALT, HID_KEY_LEFTSHIFT, HID_KEY_5));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_SHIFT_AND_SLASH,    	        DEF_REPORT(HID_MOD_KEY_LEFT_ALT, HID_KEY_LEFTSHIFT, HID_KEY_DOT));
DEF_REPORT_SEQUENCE_NAMED(LALT_AND_LSHIFT_AND_L,    	        DEF_REPORT(HID_MOD_KEY_LEFT_ALT, HID_MOD_KEY_LEFT_SHIFT, HID_KEY_L));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_EQUALOSX,    	        DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_SLASH));
DEF_REPORT_SEQUENCE_NAMED(FR_EQUALOSX,    	        DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_SLASH));
...
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_EQUAL,    	        DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_EQUAL));
DEF_REPORT_SEQUENCE_NAMED(FR_TAB,			        DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_TAB));
DEF_REPORT_SEQUENCE_NAMED(FR_COMMA,			        DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_COMMA));
DEF_REPORT_SEQUENCE_NAMED(FR_ENTER,			        DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_ENTER));
DEF_REPORT_SEQUENCE_NAMED(FR_SPACE,			        DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_SPACE));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_1,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_1));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_2,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_2));
DEF_REPORT_SEQUENCE_NAMED(FR_BACKSLASH,			    DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_BACKSLASH));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_4,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_4));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_5,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_5));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_6,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_6));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_BACKSLASH,	DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_BACKSLASH));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_8,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_8));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_9,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_9));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_RIGHTBRACE,	DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_RIGHTBRACE));
DEF_REPORT_SEQUENCE_NAMED(FR_RIGHTBRACE,			DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_RIGHTBRACE));
DEF_REPORT_SEQUENCE_NAMED(FR_SLASH,			        DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_SLASH));
DEF_REPORT_SEQUENCE_NAMED(FR_DOT,			        DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_DOT));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_7,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_7));
DEF_REPORT_SEQUENCE_NAMED(FR_0,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_0));
DEF_REPORT_SEQUENCE_NAMED(FR_1,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_1));
DEF_REPORT_SEQUENCE_NAMED(FR_2,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_2));
DEF_REPORT_SEQUENCE_NAMED(FR_3,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_3));
DEF_REPORT_SEQUENCE_NAMED(FR_4,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_4));
DEF_REPORT_SEQUENCE_NAMED(FR_5,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_5));
DEF_REPORT_SEQUENCE_NAMED(FR_6,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_6));
DEF_REPORT_SEQUENCE_NAMED(FR_7,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_7));
DEF_REPORT_SEQUENCE_NAMED(FR_8,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_8));
DEF_REPORT_SEQUENCE_NAMED(FR_9,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_9));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_DOT,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_DOT));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_COMMA,		DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_COMMA));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_0,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_0));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_MINUS,		DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_MINUS));
DEF_REPORT_SEQUENCE_NAMED(FR_MINUS,			        DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_MINUS));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_A,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_A));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_B,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_B));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_C,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_C));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_D,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_D));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_E,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_E));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_F,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_F));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_G,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_G));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_H,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_H));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_I,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_I));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_J,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_J));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_K,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_K));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_L,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_L));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_M,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_M));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_N,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_N));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_O,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_O));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_P,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_P));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_Q,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_Q));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_R,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_R));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_S,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_S));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_T,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_T));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_U,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_U));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_V,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_V));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_W,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_W));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_X,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_X));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_Y,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_Y));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_Z,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_Z));
DEF_REPORT_SEQUENCE_NAMED(FR_GRAVE,			        DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_GRAVE));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_GRAVE,		DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_GRAVE));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_SLASH,		DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_SLASH));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_EQUAL,		DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_EQUAL));
DEF_REPORT_SEQUENCE_NAMED(FR_EQUAL,			        DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_EQUAL));
DEF_REPORT_SEQUENCE_NAMED(FR_A,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_A));
DEF_REPORT_SEQUENCE_NAMED(FR_B,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_B));
DEF_REPORT_SEQUENCE_NAMED(FR_C,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_C));
DEF_REPORT_SEQUENCE_NAMED(FR_D,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_D));
DEF_REPORT_SEQUENCE_NAMED(FR_E,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_E));
DEF_REPORT_SEQUENCE_NAMED(FR_F,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_F));
DEF_REPORT_SEQUENCE_NAMED(FR_G,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_G));
DEF_REPORT_SEQUENCE_NAMED(FR_H,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_H));
DEF_REPORT_SEQUENCE_NAMED(FR_I,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_I));
DEF_REPORT_SEQUENCE_NAMED(FR_J,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_J));
DEF_REPORT_SEQUENCE_NAMED(FR_K,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_K));
DEF_REPORT_SEQUENCE_NAMED(FR_L,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_L));
DEF_REPORT_SEQUENCE_NAMED(FR_M,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_M));
DEF_REPORT_SEQUENCE_NAMED(FR_N,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_N));
DEF_REPORT_SEQUENCE_NAMED(FR_O,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_O));
DEF_REPORT_SEQUENCE_NAMED(FR_P,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_P));
DEF_REPORT_SEQUENCE_NAMED(FR_Q,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_Q));
DEF_REPORT_SEQUENCE_NAMED(FR_R,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_R));
DEF_REPORT_SEQUENCE_NAMED(FR_S,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_S));
DEF_REPORT_SEQUENCE_NAMED(FR_T,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_T));
DEF_REPORT_SEQUENCE_NAMED(FR_U,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_U));
DEF_REPORT_SEQUENCE_NAMED(FR_V,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_V));
DEF_REPORT_SEQUENCE_NAMED(FR_W,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_W));
DEF_REPORT_SEQUENCE_NAMED(FR_X,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_X));
DEF_REPORT_SEQUENCE_NAMED(FR_Y,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_Y));
DEF_REPORT_SEQUENCE_NAMED(FR_Z,			            DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_Z));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_3,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_3));
DEF_REPORT_SEQUENCE_NAMED(FR_LEFTBRACE,			    DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_LEFTBRACE));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_LEFTBRACE,	DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_LEFTBRACE));
DEF_REPORT_SEQUENCE_NAMED(FR_SEMICOLON,			    DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_SEMICOLON));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_SEMICOLON,	DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_SEMICOLON));
DEF_REPORT_SEQUENCE_NAMED(FR_APOSTROPHE,			DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_APOSTROPHE));
DEF_REPORT_SEQUENCE_NAMED(FR_SHIFT_AND_APOSTROPHE,	DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_APOSTROPHE));
...
#define LAYOUT_OSXFR(PROC_FUNC) \
    PROC_FUNC(L'\t', HID_REPORT_SEQUENCE_FR_TAB)                    \
    PROC_FUNC(L'\n', HID_REPORT_SEQUENCE_FR_ENTER)                  \
    PROC_FUNC(L' ', HID_REPORT_SEQUENCE_FR_SPACE)                   \
    PROC_FUNC(L'!', HID_REPORT_SEQUENCE_FR_SLASH)             \
    PROC_FUNC(L'@', HID_REPORT_SEQUENCE_102ND)             \
    PROC_FUNC(L'\\', HID_REPORT_SEQUENCE_RALT_AND_SHIFT_AND_SLASH)              \
    PROC_FUNC(L'$', HID_REPORT_SEQUENCE_FR_RIGHTBRACE)             \
    PROC_FUNC(L'%', HID_REPORT_SEQUENCE_FR_SHIFT_AND_APOSTROPHE)             \
    PROC_FUNC(L'^', HID_REPORT_SEQUENCE_RALT_AND_9)             \
    PROC_FUNC(L'|', HID_REPORT_SEQUENCE_LALT_AND_LSHIFT_AND_L)     \
    PROC_FUNC(L'*', HID_REPORT_SEQUENCE_FR_BACKSLASH)             \
    PROC_FUNC(L'(', HID_REPORT_SEQUENCE_FR_5)             \
    PROC_FUNC(L'}', HID_REPORT_SEQUENCE_RALT_AND_E)    \
    PROC_FUNC(L']', HID_REPORT_SEQUENCE_LALT_AND_LSHIFT_AND_0)              \
    PROC_FUNC(L',', HID_REPORT_SEQUENCE_FR_M)                   \
    PROC_FUNC(L'/', HID_REPORT_SEQUENCE_FR_SHIFT_AND_DOT)                   \
    PROC_FUNC(L'.', HID_REPORT_SEQUENCE_FR_SHIFT_AND_COMMA)                     \
    PROC_FUNC(L'&', HID_REPORT_SEQUENCE_FR_1)             \
    PROC_FUNC(L'0', HID_REPORT_SEQUENCE_FR_SHIFT_AND_0)                       \
    PROC_FUNC(L'1', HID_REPORT_SEQUENCE_FR_SHIFT_AND_1)                       \
    PROC_FUNC(L'2', HID_REPORT_SEQUENCE_FR_SHIFT_AND_2)                       \
    PROC_FUNC(L'3', HID_REPORT_SEQUENCE_FR_SHIFT_AND_3)                       \
    PROC_FUNC(L'4', HID_REPORT_SEQUENCE_FR_SHIFT_AND_4)                       \
    PROC_FUNC(L'5', HID_REPORT_SEQUENCE_FR_SHIFT_AND_5)                       \
    PROC_FUNC(L'6', HID_REPORT_SEQUENCE_FR_SHIFT_AND_6)                       \
    PROC_FUNC(L'7', HID_REPORT_SEQUENCE_FR_SHIFT_AND_7)                       \
    PROC_FUNC(L'8', HID_REPORT_SEQUENCE_FR_SHIFT_AND_8)                       \
    PROC_FUNC(L'9', HID_REPORT_SEQUENCE_FR_SHIFT_AND_9)                       \
    PROC_FUNC(L'>', HID_REPORT_SEQUENCE_FR_SHIFT_AND_GRAVE)           \
    PROC_FUNC(L'<', HID_REPORT_SEQUENCE_FR_GRAVE)         \
    PROC_FUNC(L')', HID_REPORT_SEQUENCE_FR_MINUS)             \
    PROC_FUNC(L'_', HID_REPORT_SEQUENCE_US_SHIFT_AND_EQUAL)         \
    PROC_FUNC(L'-', HID_REPORT_SEQUENCE_US_EQUAL)                   \
    PROC_FUNC(L'A', HID_REPORT_SEQUENCE_FR_SHIFT_AND_Q)             \
    PROC_FUNC(L'B', HID_REPORT_SEQUENCE_FR_SHIFT_AND_B)             \
    PROC_FUNC(L'C', HID_REPORT_SEQUENCE_FR_SHIFT_AND_C)             \
    PROC_FUNC(L'D', HID_REPORT_SEQUENCE_FR_SHIFT_AND_D)             \
    PROC_FUNC(L'E', HID_REPORT_SEQUENCE_FR_SHIFT_AND_E)             \
    PROC_FUNC(L'F', HID_REPORT_SEQUENCE_FR_SHIFT_AND_F)             \
    PROC_FUNC(L'G', HID_REPORT_SEQUENCE_FR_SHIFT_AND_G)             \
    PROC_FUNC(L'H', HID_REPORT_SEQUENCE_FR_SHIFT_AND_H)             \
    PROC_FUNC(L'I', HID_REPORT_SEQUENCE_FR_SHIFT_AND_I)             \
    PROC_FUNC(L'J', HID_REPORT_SEQUENCE_FR_SHIFT_AND_J)             \
    PROC_FUNC(L'K', HID_REPORT_SEQUENCE_FR_SHIFT_AND_K)             \
    PROC_FUNC(L'L', HID_REPORT_SEQUENCE_FR_SHIFT_AND_L)             \
    PROC_FUNC(L'M', HID_REPORT_SEQUENCE_FR_SHIFT_AND_SEMICOLON)             \
    PROC_FUNC(L'N', HID_REPORT_SEQUENCE_FR_SHIFT_AND_N)             \
    PROC_FUNC(L'O', HID_REPORT_SEQUENCE_FR_SHIFT_AND_O)             \
    PROC_FUNC(L'P', HID_REPORT_SEQUENCE_FR_SHIFT_AND_P)             \
    PROC_FUNC(L'Q', HID_REPORT_SEQUENCE_FR_SHIFT_AND_A)             \
    PROC_FUNC(L'R', HID_REPORT_SEQUENCE_FR_SHIFT_AND_R)             \
    PROC_FUNC(L'S', HID_REPORT_SEQUENCE_FR_SHIFT_AND_S)             \
    PROC_FUNC(L'T', HID_REPORT_SEQUENCE_FR_SHIFT_AND_T)             \
    PROC_FUNC(L'U', HID_REPORT_SEQUENCE_FR_SHIFT_AND_U)             \
    PROC_FUNC(L'V', HID_REPORT_SEQUENCE_FR_SHIFT_AND_V)             \
    PROC_FUNC(L'W', HID_REPORT_SEQUENCE_FR_SHIFT_AND_Z)             \
    PROC_FUNC(L'X', HID_REPORT_SEQUENCE_FR_SHIFT_AND_X)             \
    PROC_FUNC(L'Y', HID_REPORT_SEQUENCE_FR_SHIFT_AND_Y)             \
    PROC_FUNC(L'Z', HID_REPORT_SEQUENCE_FR_SHIFT_AND_W)             \
    PROC_FUNC(L'?', HID_REPORT_SEQUENCE_FR_SHIFT_AND_M)         \
    PROC_FUNC(L'+', HID_REPORT_SEQUENCE_FR_SHIFT_AND_EQUALOSX)         \
    PROC_FUNC(L'=', HID_REPORT_SEQUENCE_FR_EQUALOSX)                   \
    PROC_FUNC(L'a', HID_REPORT_SEQUENCE_FR_Q)                       \
    PROC_FUNC(L'b', HID_REPORT_SEQUENCE_FR_B)                       \
    PROC_FUNC(L'c', HID_REPORT_SEQUENCE_FR_C)                       \
    PROC_FUNC(L'd', HID_REPORT_SEQUENCE_FR_D)                       \
    PROC_FUNC(L'e', HID_REPORT_SEQUENCE_FR_E)                       \
    PROC_FUNC(L'f', HID_REPORT_SEQUENCE_FR_F)                       \
    PROC_FUNC(L'g', HID_REPORT_SEQUENCE_FR_G)                       \
    PROC_FUNC(L'h', HID_REPORT_SEQUENCE_FR_H)                       \
    PROC_FUNC(L'i', HID_REPORT_SEQUENCE_FR_I)                       \
    PROC_FUNC(L'j', HID_REPORT_SEQUENCE_FR_J)                       \
    PROC_FUNC(L'k', HID_REPORT_SEQUENCE_FR_K)                       \
    PROC_FUNC(L'l', HID_REPORT_SEQUENCE_FR_L)                       \
    PROC_FUNC(L'm', HID_REPORT_SEQUENCE_FR_SEMICOLON)                       \
    PROC_FUNC(L'n', HID_REPORT_SEQUENCE_FR_N)                       \
    PROC_FUNC(L'o', HID_REPORT_SEQUENCE_FR_O)                       \
    PROC_FUNC(L'p', HID_REPORT_SEQUENCE_FR_P)                       \
    PROC_FUNC(L'q', HID_REPORT_SEQUENCE_FR_A)                       \
    PROC_FUNC(L'r', HID_REPORT_SEQUENCE_FR_R)                       \
    PROC_FUNC(L's', HID_REPORT_SEQUENCE_FR_S)                       \
    PROC_FUNC(L't', HID_REPORT_SEQUENCE_FR_T)                       \
    PROC_FUNC(L'u', HID_REPORT_SEQUENCE_FR_U)                       \
    PROC_FUNC(L'v', HID_REPORT_SEQUENCE_FR_V)                       \
    PROC_FUNC(L'w', HID_REPORT_SEQUENCE_FR_Z)                       \
    PROC_FUNC(L'x', HID_REPORT_SEQUENCE_FR_X)                       \
    PROC_FUNC(L'y', HID_REPORT_SEQUENCE_FR_Y)                       \
    PROC_FUNC(L'z', HID_REPORT_SEQUENCE_FR_W)                       \
    PROC_FUNC(L'#', HID_REPORT_SEQUENCE_SHIFT_AND_102ND)             \
    PROC_FUNC(L'[', HID_REPORT_SEQUENCE_LALT_AND_LSHIFT_AND_5)               \
    PROC_FUNC(L'{', HID_REPORT_SEQUENCE_RALT_AND_4)     \
    PROC_FUNC(L';', HID_REPORT_SEQUENCE_FR_COMMA)               \
    PROC_FUNC(L':', HID_REPORT_SEQUENCE_FR_DOT)     \
    PROC_FUNC(L'\'', HID_REPORT_SEQUENCE_FR_4)             \
    PROC_FUNC(L'"', HID_REPORT_SEQUENCE_FR_3)    \
...
#define LAYOUT_FR(PROC_FUNC) \
    ...
    PROC_FUNC(L'-', HID_REPORT_SEQUENCE_FR_6)                   \
    PROC_FUNC(L'A', HID_REPORT_SEQUENCE_FR_SHIFT_AND_Q)             \
    PROC_FUNC(L'B', HID_REPORT_SEQUENCE_FR_SHIFT_AND_B)             \
    PROC_FUNC(L'C', HID_REPORT_SEQUENCE_FR_SHIFT_AND_C)             \
    PROC_FUNC(L'D', HID_REPORT_SEQUENCE_FR_SHIFT_AND_D)             \
    ...
    PROC_FUNC(L'~', HID_REPORT_SEQUENCE_FR_SHIFT_AND_GRAVE)         \
    PROC_FUNC(L'?', HID_REPORT_SEQUENCE_FR_SHIFT_AND_M)         \
    PROC_FUNC(L'+', HID_REPORT_SEQUENCE_FR_SHIFT_AND_EQUAL)         \
    PROC_FUNC(L'=', HID_REPORT_SEQUENCE_FR_SLASH)                   \
    PROC_FUNC(L'a', HID_REPORT_SEQUENCE_FR_Q)                       \
    PROC_FUNC(L'b', HID_REPORT_SEQUENCE_FR_B)                       \
    PROC_FUNC(L'c', HID_REPORT_SEQUENCE_FR_C)                       \
